...
public class Login extends javax.swing.JFrame {
    ...
    static String  oldPassword="admin";
    public Login() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 310, 200, -1));
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 380, 200, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 490, -1, -1));
        ...
        jLabel4.setText("Sri Lakshmi Stores");
        jLabel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 102, 102))); // NOI18N
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 480, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(jTextField1.getText().equals("bms")&&jPasswordField1.getText().equals(confirmPassword))
        {
            setVisible(false);
    ...
    if (currentPassword.equals(oldPassword)) {
        ...
        confirmPassword = JOptionPane.showInputDialog(null, "Confirm new password:");
        
        if (newPassword.equals(confirmPassword)) {
            
            // Update the password (you can save this to a database or variable)
            jPasswordField1.setText(newPassword);
             oldPassword=newPassword;
             confirmPassword = newPassword;
             System.out.println("Stored confirmPassword: " + confirmPassword);
